...
// --- 1. ALLOWED DOMAINS (Kept for reference, but check is disabled below for stability) ---
...
// --- 3. EXPRESS CORS SETUP (PERMISSIVE FIX) ---
// We use 'origin: true' to reflect the request origin. This fixes the preflight error.
app.use(cors({
  origin: true, 
  credentials: true,
